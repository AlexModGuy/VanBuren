...
public class WorldGenWastelandLake extends WorldGenerator {
    ...
    public WorldGenWastelandLake(Block blockIn) {
        this.block = blockIn;
    }
                    ...
                    for (int k3 = 0; k3 < 16; ++k3) {
                        for (int k4 = 0; k4 < 8; ++k4) {
                            ...
                            if (flag1 && (k4 < 4 || rand.nextInt(2) != 0) && worldIn.getBlockState(position.add(j2, k4, k3)).getMaterial().isSolid()) {
                                worldIn.setBlockState(position.add(j2, k4, k3), OWBBlocks.IRRADIATED_STONE.getDefaultState(), 2);
                            }
                        }
                    }
                }
                ...
                for (int j2 = 0; j2 < 16; ++j2) {
                    for (int k3 = 0; k3 < 16; ++k3) {
                        for (int k4 = 0; k4 < 8; ++k4) {
                            ...
                            if (flag1 && (k4 < 4 || rand.nextInt(2) != 0) && worldIn.getBlockState(position.add(j2, k4, k3)).getMaterial().isSolid()) {
                                worldIn.setBlockState(position.add(j2, k4, k3), OWBBlocks.IRRADIATED_MUD.getDefaultState(), 2);
                            }
                        }
                    }
                }
