...
public class BlockVaultLighting extends BlockHorizontal {

    public static final PropertyEnum<BlockVaultLighting.Half> HALF = PropertyEnum.<BlockVaultLighting.Half>create("half", BlockVaultLighting.Half.class);
    protected static final AxisAlignedBB AABB_BOTTOM_HALF_NS = new AxisAlignedBB(0.1875D, 0.0D, 0.0D, 0.8125D, 0.1875D, 1.0D);
    protected static final AxisAlignedBB AABB_BOTTOM_HALF_EW = new AxisAlignedBB(0.0D, 0.0D, 0.1875D, 1.0D, 0.1875D, 0.8125D);
    protected static final AxisAlignedBB AABB_TOP_HALF_NS = new AxisAlignedBB(0.1875D, 0.8125D, 0.0D, 0.8125D, 1.0D, 1.0D);
    protected static final AxisAlignedBB AABB_TOP_HALF_EW = new AxisAlignedBB(0.0D, 0.8125D, 0.1875D, 1.0D, 1.0D, 0.8125D);

    public BlockVaultLighting() {
        super(Material.IRON);
        this.setHardness(5F);
