...
public class BlockMetalTableSeat extends BlockHorizontal implements ISittable{
    ...
    protected static final AxisAlignedBB AABB_EAST = new AxisAlignedBB(0.25D, 0.0D, 0.0D, 1.0D, 0.5D, 1.0D);
    protected static final AxisAlignedBB AABB_WEST = new AxisAlignedBB(0.0D, 0D, 0.0D, 0.75D, 0.5D, 1.0D);

    public BlockMetalTableSeat() {
        super(Material.IRON);
        this.setHardness(5F);
    ...
    public void startRiding(EntityLivingBase rider, IBlockState blockState, BlockPos pos) {
        ...
        seat.setPosition(pos.getX() + 0.5D, pos.getY() - 0.15D, pos.getZ() + 0.5D);
