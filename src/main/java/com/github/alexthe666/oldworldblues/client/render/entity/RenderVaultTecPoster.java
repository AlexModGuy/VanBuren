...
public class RenderVaultTecPoster extends Render<EntityVaultTecPoster>{
    private static final ResourceLocation TEXTURE = new ResourceLocation(OldWorldBlues.MODID, "textures/painting/vault_tec_posters.png");

    public RenderVaultTecPoster(RenderManager renderManager) {
        super(renderManager);
    }

    private void renderTablet(EntityVaultTecPoster entity, int width, int height, int textureU, int textureV) {
    ...
    private void setLightmap(EntityVaultTecPoster entity, float centerX, float centerY) {
    ...
    @Override
    public void doRender(EntityVaultTecPoster entity, double x, double y, double z, float yaw, float partialTicks) {
        GlStateManager.pushMatrix();
        GlStateManager.translate(x, y, z);
        GlStateManager.rotate(180.0F - yaw, 0.0F, 1.0F, 0.0F);
        GlStateManager.enableRescaleNormal();
        this.bindEntityTexture(entity);
        EntityVaultTecPoster.Variant variant = entity.variant;
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityVaultTecPoster entity) {
        return TEXTURE;
    }
}
